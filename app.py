...
if not saccos:
    ...
    PAGES = {
        ...
        "🏅 Gold Points":         gold_points.render,       # NEW
        "🇺🇬 NSSF Compliance":    nssf_admin.render,        # NEW — super-admin only
    ...
    PAGES = {
        ...
        "📈 Reports":             reports.render,
        "📊 Analytics":           analytics.render,
        "🏅 Gold Points":         gold_points.render,       # NEW — staff can celebrate members
        "🤖 AI Insights":         ai_insights.render,
        "🔑 Account Settings":    render_account_settings,
        # Note: NSSF Compliance is intentionally admin-only — staff don't see it
    }
